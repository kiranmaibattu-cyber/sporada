...
RUN = ROOT / "run" / f"sporada-v17-crossing-{int(time.time())}"
IMAGE = "localhost/sporada:intel-285h-2026.09.22-v17"
NAME = "sporada-v17-crossing-test"
...
def main() -> None:
    ...
    try:
        ...
        validator = Draft202012Validator(json.loads(
            (ROOT / "delivery/apexfabric-v1/intel-285h/sporada-secure-v17/vehicle-crossing.schema.json").read_text()
        ))
